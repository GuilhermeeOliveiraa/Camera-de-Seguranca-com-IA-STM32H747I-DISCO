...
__attribute__ ((aligned (32)))
static uint8_t NN_Activation_Buffer_SDRAM[AI_ACTIVATION_2_SIZE_BYTES + 32 - (AI_ACTIVATION_2_SIZE_BYTES%32)];
__attribute__((section(".NN_Activation_Buffer_AXIRAM")))
__attribute__ ((aligned (32)))
static uint8_t NN_Activation_Buffer_AXIRAM[AI_ACTIVATION_3_SIZE_BYTES + 32 - (AI_ACTIVATION_3_SIZE_BYTES%32)];
ai_handle NN_Activation_Buffer[AI_ACTIVATION_BUFFERS_COUNT] = { NN_Activation_Buffer_DTCMRAM, NN_Activation_Buffer_SDRAM, NN_Activation_Buffer_AXIRAM, };
...
uint8_t pixel_conv_lut[256];
  ...
  postprocess_outBuffer_t out_postproc[AI_OD_SSD_ST_PP_TOTAL_DETECTIONS];
